...
//// http://viclw17.github.io/2018/07/16/raytracing-ray-sphere-intersection/
    ...
    // sphere: dot(pointOnSphere - center, pointOnSphere - center) - r * r = 0
    ...
    float b = 2 * dot(rayDirection, rayOrigin - centerCameraSpace);
...
//// https://www.scratchapixel.com/lessons/3d-basic-rendering/introduction-to-shading/reflection-refraction-fresnel
        ...
        vec3 enterNormalNormalized = normalize(enteringPointOnSphereWorldSpace - center);
        ...
        b = 2 * dot(enteringRefractedDirectionNormalized, enteringPointOnSphereWorldSpace - center);
        c = dot( enteringPointOnSphereWorldSpace - center, enteringPointOnSphereWorldSpace - center) - radius *radius;
        d = b * b - 4 /** a */ * c; // a is 1
        ...
        if(d > - 0.0000001){
            ...
            vec3 exitNormalNormalized = normalize(exitingPointOnSphereWorldSpace - center);
